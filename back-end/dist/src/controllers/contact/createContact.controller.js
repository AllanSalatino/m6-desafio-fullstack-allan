...
const createContactController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const contact = yield req.body;
    const idClient = req.client.id;
    const createdClient = yield (0, createContact_service_1.default)(contact, idClient);
    return res.status(201).json((0, class_transformer_1.instanceToPlain)(createdClient));
});
